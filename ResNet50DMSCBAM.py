...
class ResNet50DMSCBAM(nn.Module):
    def __init__(self, num_classes=4, reduction=16):
        super(ResNet50DMSCBAM, self).__init__()
        self.resnet = resnet50(weights=None)
        # 在每个 layer 后插入 DMS_CBAM 模块
        self.dms_cbam1 = DMS_CBAM(256, reduction)
        self.dms_cbam2 = DMS_CBAM(512, reduction)
        self.dms_cbam3 = DMS_CBAM(1024, reduction)
        self.dms_cbam4 = DMS_CBAM(2048, reduction)
